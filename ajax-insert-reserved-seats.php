<?php 
    ...
    if(strlen($reserved_seats)==0){
        ...
        if($film_seats){
            ...
            $result_bestellung =  mysqli_query($con, "Insert Into kinoticketing.user_schaut_film (Film_ID, Film_Name, User_Name, Reserved_Seats) VALUES('$film_ID', '$film_name', '$user_username', '$reserved_seats')");
