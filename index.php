...
<html>
  ...
  <body>
    ...
    <?php include('./functions/slider-functions.php')/*enthält make_slide_indicators() und make_slides()*/ ?> 
    ...
    <main role="main" style="padding-top: 0px; padding-bottom: 30px">
      ...
      <?php $result_4_films = mysqli_query($con,  "Select * from kinoticketing.film WHERE ID>15");?>
      <!--Filmcards-->
